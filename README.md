...
dependencies {
    ksp("io.github.doljae:kotlin-logging-extensions:2.2.10-0.0.2")
    implementation("io.github.doljae:kotlin-logging-extensions:2.2.10-0.0.2")
...
| Library | Kotlin | KSP |
|---------|--------|-----|
| `2.2.10-0.0.2` | `2.2.10` | `2.2.0-2.0.2` |
